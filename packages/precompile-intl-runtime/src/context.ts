...
import { createI18n, isI18n } from './i18n.svelte.js';
...
export function provideI18n(input: () => I18nOptions | I18n): I18n;
export function provideI18n(input: I18nOptions): I18n;
export function provideI18n(input: I18n): I18n;
export function provideI18n(input: I18nProviderInput): I18n {
  const options = isI18n(input) ? input : typeof input === 'function' ? input() : input;
  const i18n = isI18n(options) ? options : createI18n(options);
